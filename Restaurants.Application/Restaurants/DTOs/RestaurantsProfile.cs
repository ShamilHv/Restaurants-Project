...
public class RestaurantsProfile : Profile
{
    ...
    {
        CreateMap<Domain.Entities.Restaurant, RestaurantDto>().ForMember(d => d.City,
        ...
        CreateMap<CreateRestaurantCommand, Domain.Entities.Restaurant>().ForMember(d => d.Address, opt => opt.MapFrom(src =>
            new Address
            {
                City = src.City,
